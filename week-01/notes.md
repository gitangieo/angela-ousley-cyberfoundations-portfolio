...
- Career paths in cybersecurity and where this course fits
- What GitHub is, and why a portfolio repo matters for your career
- The CyberFoundations City map — your guide to the next 11 weeks

## In My Own Words

**What is the CIA Triad, in your own words?**
- Confidentiality: only authorized users can access private data
- Integrity: ensuring data isn't edited by someone unauthorized or edited by mistake
- Availability: making sure systems/data are available when needed
